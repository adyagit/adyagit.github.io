...
Padding is a convenient way to maintain the image size convolve an image without shrinking the image size. With padding the 
...
General formula to determine the padding is 
